classdef clsPS09_old
    ...
    start_newcycle = 0xCC;
         ...
         ConfigParam= struct(...
            ...
            'caltime',          [ 14 1   2 1  ],... %
            'con_comp',         [ 12 18  2 1  ],... %
            'connect_vcc_rosc', [ 00 00  0 0  ],... %
            'cport_adapt',    [ 15 23  1 1  ],... %
            'cport_en',       [ 15 16  4 0  ],... %
            'cport_r',        [ 15 20  2 0  ],... %
            'cport_thresh1',  [ 15 0   8 -1],... %
    ...
    methods
        function obj = init(obj)
           ...
           % c_reg0 = [ hex2dec('00'), hex2dec('30'), hex2dec('23'), hex2dec('00'), hex2dec('D2')];
            ...
            %    ConfigParam_00 = struct(...
            %      'connect_vcc_rosc', [ 00 00  1  0 ],... %
            %      'tdc_conv_cnt',     [ 00 16  8  -1],... %
            %      'cpu_speed',        [ 00 1   2  1 ],... Recommended Value = 1 (fix)
            %      'io_a',             [ 00 8   8  -1],... %
            %      'osz10khz_fsoc',    [ 00 4   4  13],... % Recommended Value = 13 (fix) 
            %      'mod_math',         [ 00 3   1  0 ]... %
            %      )
